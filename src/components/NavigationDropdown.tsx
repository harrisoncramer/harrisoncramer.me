...
const NavigationDropdown = (): JSX.Element => {
  ...
  return (
    <nav>
      ...
      <ul className={`mt-4 w-48 absolute transition-opacity overflow-hidden ${!isDropdownOpen ? 'opacity-0' : 'opacity-100'} bg-app-black text-app-white shadow rounded-md`}>
        <a className={`block text-xl relative hover:bg-app-background-light text-app-white ${isDropdownOpen && 'cursor-pointer'} px-4 py-2 w-full` } href="/blog"><h3>Blog</h3></a>
