...
const Header = ({ children, stars }: HeaderProps): JSX.Element => {
  ...
  return (
      ...
      {stars !== null && (
        <a className="navbar-item github flex gap-2" href="https://github.com/harrisoncramer/harrisoncramer.me" target="_blank" aria-label="Star us on GitHub">
          <div className="w-6">
          ...
          <div className="flex items-center bg-app-white px-2 gap-1 rounded-sm">
            <span className="text-app-black text-sm h-full flex items-center mt-1">{stars}</span>
