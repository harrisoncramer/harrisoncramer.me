...
<img src="/inline_images/RabbitMQ.png" alt="This is how RabbitMQ's direct exchange works." />
...
<img src="/inline_images/rabbitMQfanout.png" alt="The 'fanout' routing strategy sends a message to every bound queue." />
...
<img src="/inline_images/rabbitTopicExchange.png" alt="The topic exchange sends a message to every queue whose binding key partly matches the routing key." />
...
<img src="/inline_images/RabbitMQDashboard.png" alt="RabbitMQ's management dashboard provides a powerful GUI for the message broker." />
...
<img src="/inline_images/RabbitMQMessages.png" alt="The management console shows that we've send a few messages to the RabbitMQ message broker." />
