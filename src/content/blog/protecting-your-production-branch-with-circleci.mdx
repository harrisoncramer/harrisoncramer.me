...
The repository for this application can be downloaded <a href="https://s3.amazonaws.com/harrisoncramer.me.assets/circleci.tar.gz">from my S3 bucket here</a>.
...
<img src="/inline_images/github-settings.png" alt="Github Settings Tab" />

Next, click on the "Branches" tab. Then we want to add a rule.

<img src="/inline_images/github-branch-rules.png" alt="Github branch rules" />
...
<img src="/inline_images/github-branch-rules.png" alt="Branch rules" />
...
<img src="/inline_images/circle-error.png" alt="CircleCI Error" />
...
<img src="/inline_images/github-no-error-merge.png" alt="Github status checks" />
