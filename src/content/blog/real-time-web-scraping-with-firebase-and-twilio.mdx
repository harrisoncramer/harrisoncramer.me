...
<p class="tip">Firebase will update outdated functions whenever you change the code and redeploy. It can't do that in our case, however, because we wrote an HTTP function the first time and a schedule function the second time.</p>
...
<img src="/inline_images/firebase-logs.jpg" alt="The console logs inside of your function will show up here." />
<p>The console logs inside of your function will show up here.</p>
...
You can read more about these different methods and what they do <a href="https://firebase.google.com/docs/reference/functions/providers_database.refbuilder#on-create">on firebase's documentation</a>.
...
The full code for this (as well as a more complex example) can be found <a href="https://github.com/harrisoncramer/streetsleazy/tree/blog-scraper">on my Github</a>.
