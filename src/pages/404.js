...
var browser = typeof window !== "undefined" && window;
var NotFoundPage = function () { return (React.createElement(layout_1.default, { title: "404" },
    React.createElement(seo_1.default, { description: "This page returned a 404 error.", title: "404" }),
    ...
    React.createElement("p", null,
        "Head back to the ",
        React.createElement(gatsby_1.Link, { to: "/blog" }, "blog"),
        " if you want!"))); };
